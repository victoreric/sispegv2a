...
<a href="dai" class="btn-sm btn-info fa fa-plus-circle">   </a>
       <p>
        ...
        <?php
          ...
          while ($hasil=mysqli_fetch_array($sql))
          {
            ...
            echo "
	          ...
	          echo " <th> <a href='dap?n=".$hasil['nip']."' data-toggle='tooltip' title='Klik untuk lihat data pribadi!'> <img src='../assets/images/".$hasil['foto']."'  width='70' height='90'> </th>  </a>
            ...
            ?>
              <th>
                <a href="dah?n=<?php echo "".$hasil['nip'] ; ?>" class="btn-sm btn-danger fas fa-fas fa-trash-alt" onclick="javascript:return confirm('Anda Yakin Akan Menghapus Data??')"></a>

                <a href="dae?n=<?php echo "".$hasil['nip'] ; ?>" class="btn-sm btn-warning fas fa-edit mt-2"> </a>
              </th>
           </tr>   
	      <?php } ?> 
</table>
